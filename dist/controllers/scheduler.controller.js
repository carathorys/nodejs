...
var SchedulerController = (function () {
    function SchedulerController(SchedulerService, logger) {
        this.SchedulerService = SchedulerService;
        this.logger = logger;
    }
    SchedulerController.prototype.start = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res;
            return __generator(this, function (_a) {
                req = params.req, res = params.res;
    ...
    SchedulerController.prototype.show = function (params) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var req, res, jobsFound;
            return __generator(this, function (_b) {
                req = params.req, res = params.res;
                console.log(req.params);
                jobsFound = this.SchedulerService.FilterJobs(function (x) { return true; });
                if ((_a = jobsFound === null || jobsFound === void 0 ? void 0 : jobsFound.length) !== null && _a !== void 0 ? _a : 0 === 0) {
